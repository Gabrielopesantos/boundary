...
func (s Service) listFromRepo(ctx context.Context, storeId string) ([]credential.StaticCredential, error) {
	...
	creds := make([]credential.StaticCredential, 0, len(up))
	for _, s := range up {
...
func (s Service) getFromRepo(ctx context.Context, id string) (credential.StaticCredential, error) {
...
func (s Service) createInRepo(ctx context.Context, scopeId string, item *pb.Credential) (credential.StaticCredential, error) {
...
func (s Service) updateInRepo(
	...
	masks []string,
	in *pb.Credential,
) (credential.StaticCredential, error) {
...
func toProto(in credential.StaticCredential, opt ...handlers.Option) (*pb.Credential, error) {
